# Deployment evidence — 20260803-093841Z
...
| Metric | Value | Source |
|---|---|---|
| NF profiles registered in NRF | 8 | MongoDB `NfProfile` |
...
| AMF `ue_connectivity{3GPP}` | 2 | AMF exporter (unreliable — see below) |
| AMF `ue_cm_gmm_state_count{cm-connected}` | 40 | AMF exporter (unreliable — see below) |
