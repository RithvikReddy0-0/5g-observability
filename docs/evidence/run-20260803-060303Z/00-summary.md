# Deployment evidence — 20260803-060303Z
...
| Metric | Value | Source |
|---|---|---|
| NF profiles registered in NRF | 7 | MongoDB `NfProfile` |
...
| AMF `ue_connectivity{3GPP}` | 3 | AMF exporter (unreliable — see below) |
| AMF `ue_cm_gmm_state_count{cm-connected}` | 63 | AMF exporter (unreliable — see below) |
